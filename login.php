<?php
  ...
  if ($db){
    if (isset($_POST['login'])){
      ...
      $num = pg_num_rows($sql);
      if ($num==1 && $email != 'admin@gmail.com' && $pass != 'admin'){
        $_SESSION['email'] = $_POST['email'];
        echo '<script>window.alert("Login Successful");</script>';
        echo "<script>location.href='index.php'</script>";
      }
      else {
        echo '<script>alert("Account does not exits!Please create an account for movie browsing");</script>';
    ...
    if (isset($_POST['signup'])){
      ...
      $dir = './profile/';
      move_uploaded_file($profile['tmp_name'], $dir.$profile['name']);
      ...
      if ($num==1){
        ...
        $_SESSION['email'] = $_POST['email'];
        $sql1 = pg_query($db, "INSERT INTO login VALUES ('$username', '$email', '$pass', '$profile[name]')");
...
<div class="container" id="container">
  <div class="form-container sign-up-container">
    <form method="post" enctype="multipart/form-data">
      ...
      <input type="file" placeholder="Upload profile" name="profile" required>
  ...
  <div class="form-container sign-in-container">
    <form method="post">
      ...
      <input type="submit" name="admin" class="button" onclick="window.location.href='admin_login.php'" value="ADMIN LOG IN">
    </form>
  </div>
  <div class="overlay-container">
    <div class="overlay">
      ...
      <div class="overlay-panel overlay-right">
        ...
        <p>Enter your personal details and start browsing the movies!!</p>
