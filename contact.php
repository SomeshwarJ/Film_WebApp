    ...
    <div class="content">
      <div class="left-side">
        <div class="email details">
          ...
          <div class="text-one">movieinfo@gmail.com</div>
          <div class="text-two">info.movieinfo@gmail.com</div>
        </div>
      </div>
  ...
  <?php
    ...
    if ($db){
      if (isset($_POST['submit'])){
        ...
        $sql = pg_query($db, "INSERT INTO contact VALUES ('$username', '$email', '$subject')");
        if ($sql){
